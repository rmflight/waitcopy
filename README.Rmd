...
* if SHA-1 is new, add the new file name, original file path, and SHA-1 to the master
  json file
* if SHA-1 is not new, **add** the original file path to the matching file entry
  in the master json file.
* if a matching file name is found but with a different SHA-1 hash, append the
  first 8 digits of the SHA-1 hash to the file name, and add it to the json data
