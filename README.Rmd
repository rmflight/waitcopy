...
bit between each copy operation, checks for duplicates (via names and md5 hashing),
strips the file name of special characters, and notes where the file originated.
